...
@ShortName("AccountWork")
@Events(values={"IdToken (token As String)"})
public class AccountWork {
    ...
    public static HuaweiIdAuthService initSetup(final Context context) {
	...
	private static IOnActivityResult ion;
        ...
        public static void ListenForIdToken(final Context context) {
            ...
            ion = new IOnActivityResult() {
                ...
                public void ResultArrived(int resultCode, Intent data) {
					...
					if (authHuaweiIdTask.isSuccessful()) {
						...
						String s = huaweiAccount.getIdToken();
						
						Log.i(TAG, "idToken:" + s);
						Log.i(TAG, huaweiAccount.getDisplayName() + " signIn success ");
						ba.raiseEventFromUI(this, eventName + "_idtoken", s);
					} else {
						//The sign-in failed.
            ...
            ba.startActivityForResult(ion, initSetup(ba.context).getSignInIntent());
        }
