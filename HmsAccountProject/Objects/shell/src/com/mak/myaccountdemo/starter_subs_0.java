...
if (RapidSub.canDelegate("application_error")) { return com.mak.myaccountdemo.starter.remoteMe.runUserSub(false, "starter","application_error", _error, _stacktrace);}
...
if (RapidSub.canDelegate("service_create")) { return com.mak.myaccountdemo.starter.remoteMe.runUserSub(false, "starter","service_create");}
...
if (RapidSub.canDelegate("service_destroy")) { return com.mak.myaccountdemo.starter.remoteMe.runUserSub(false, "starter","service_destroy");}
...
if (RapidSub.canDelegate("service_start")) { return com.mak.myaccountdemo.starter.remoteMe.runUserSub(false, "starter","service_start", _startingintent);}
...
if (RapidSub.canDelegate("service_taskremoved")) { return com.mak.myaccountdemo.starter.remoteMe.runUserSub(false, "starter","service_taskremoved");}
